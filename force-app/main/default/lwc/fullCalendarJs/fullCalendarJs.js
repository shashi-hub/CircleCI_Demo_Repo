...
import fetchAllEvents from '@salesforce/apex/EventController.fetchAllEvents';
/**
 * FullCalendarJs
...
export default class FullCalendarJs extends NavigationMixin(LightningElement) {
  ...
  renderedCallback() {
    ...
    Promise.all([
      loadScript(this, FullCalendarJS + '/full-calendar-js-master/FullCalendarJS/jquery.min.js'),
      loadScript(this, FullCalendarJS + '/full-calendar-js-master/FullCalendarJS/theme.js'),
      loadScript(this, FullCalendarJS + '/full-calendar-js-master/FullCalendarJS/moment.min.js'),
      loadScript(this, FullCalendarJS + '/full-calendar-js-master/FullCalendarJS/fullcalendar.min.js'),
      loadStyle(this, FullCalendarJS + '/full-calendar-js-master/FullCalendarJS/fullcalendar.min.css'),
  ...
  initialiseFullCalendarJs() {
    //const prev = this.template.querySelector('div.fc-prev-button');
//    const prev = this.template.querySelector('.fc-button-prev');
//    $(prev).click(function(){
...
//  });
    ...
    $(ele).fullCalendar({
      ...
      datesSet: function(event, jsEvent, view) {
        alert('Event Clicked ');
